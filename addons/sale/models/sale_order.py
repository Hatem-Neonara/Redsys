...
class SaleOrder(models.Model):
    ...
    amount_invoiced = fields.Monetary(string="Already invoiced", compute='_compute_amount_invoiced', compute_sudo=True,)  # compute `amount_invoiced` in sudo like the stored `amount_*` fields
