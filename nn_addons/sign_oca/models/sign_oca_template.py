...
class SignOcaTemplate(models.Model):
    ...
    data = fields.Binary(attachment=True, required=True, string="Fichier")
    ask_location = fields.Boolean(string="Demander Localisation")
...
class SignOcaTemplateItem(models.Model):
    ...
    field_id = fields.Many2one("sign.oca.field", ondelete="restrict", string="Champ")
    role_id = fields.Many2one("sign.oca.role", string="Rôle", default=lambda r: r._get_default_role(),
                              ondelete="restrict")
